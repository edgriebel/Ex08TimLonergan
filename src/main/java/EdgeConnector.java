...
public class EdgeConnector {
   ...
   public EdgeConnector(String inputString) {
      ...
      isEP1Table = false;
      isEP2Table = false;
      logger.debug("EdgeConnector initialized",inputString);
   }
   ...
   public void setIsEP1Field(boolean value) {
      isEP1Field = value;
      logger.debug(String.format("Set isEP1Field to %b",value));
   }
   
   public void setIsEP2Field(boolean value) {
      isEP2Field = value;
      logger.debug(String.format("Set isEP2Field to %b",value));
   }

   public void setIsEP1Table(boolean value) {
      isEP1Table = value;
      logger.debug(String.format("Set isEP1Table to %b",value));
   }

   public void setIsEP2Table(boolean value) {
      isEP2Table = value;
      logger.debug(String.format("Set isEP2Table to %b",value));
   }
}
